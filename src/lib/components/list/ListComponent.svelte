...
>
  <div class="card-content">
    ...
    <!-- Action buttons -->
    <div class="zl-actions-toolbar">
      <!-- Toolbar buttons here -->
      {#if !isAddingItem && list.items.length > 0}
        <button 
          class="zl-add-button" 
          on:click|stopPropagation={toggleAddItemForm}
...
<style>
  ...
  .list-title {
    ...
    border-bottom: 1px solid rgba(201, 120, 255, 0.2);
  ...
  .list-title:hover {
    color: #b666e6;
    text-shadow: 0 0 10px rgba(201, 120, 255, 0.3);
  }
  ...
  .zl-footer-actions {
    ...
    border-top: 1px solid rgba(201, 120, 255, 0.2);
    width: 100%;
  }
  ...
  .zl-action-btn:hover {
    opacity: 1;
    background-color: rgba(201, 120, 255, 0.1);
    transform: translateY(-2px);
  }
