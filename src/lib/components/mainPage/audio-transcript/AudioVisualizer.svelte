...
<style>
  ...
  :global([data-theme="nocturne"] .history-bar) {
    animation:
      ...
      nocturneBars 3s ease-in-out infinite;
    ...
    box-shadow:
      ...
      0 0 20px rgba(255, 156, 227, 0.1);
  }

  /* Special animation for nocturne theme bars */
  @keyframes nocturneBars {
    0%,
    100% {
      filter: drop-shadow(0 0 2px rgba(255, 156, 227, 0.3));
    }
    25% {
      filter: drop-shadow(0 0 3px rgba(169, 255, 156, 0.3));
    }
    50% {
      filter: drop-shadow(0 0 3px rgba(156, 221, 255, 0.3));
    }
    75% {
      filter: drop-shadow(0 0 2px rgba(255, 234, 138, 0.3));
    }
  }
