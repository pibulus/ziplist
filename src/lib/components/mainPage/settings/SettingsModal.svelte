    ...
    <div class="animate-fadeUp space-y-4">
      ...
      >
        <div class="flex items-center justify-between">
          <h4 class="text-sm font-bold text-gray-700">
            Advanced Features <span class="text-xs font-normal text-pink-500"
              >(Coming Soon)</span
            >
          </h4>
          <span
        ...
        <div class="space-y-2 pt-1">
          ...
          <div class="flex items-center justify-between">
            <span class="text-xs font-medium text-gray-600"
              >Privacy Mode (offline-only)</span
            >
            <input
              type="checkbox"
              disabled
              class="toggle toggle-primary toggle-xs bg-gray-200"
            />
          </div>

          <div class="flex items-center justify-between">
            <span class="text-xs font-medium text-gray-600"
              >Export lists (CSV/JSON)</span
            >
            <input
              type="checkbox"
              disabled
      ...
      <div class="border-t border-pink-100 pt-2 text-center">
        <p class="text-xs text-gray-500">
          ZipList • Made with 💜 by Dennis & Pablo
        </p>
      </div>
    </div>
  </div>
