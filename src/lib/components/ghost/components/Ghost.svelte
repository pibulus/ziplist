  ...
  >
    ...
    <g class="ghost-spin-pivot" id="ghost-spin-pivot">
      ...
      >
        ...
        <g class="ghost-layer ghost-mouth">
          <path
            d={GHOST_MOUTH_TOP_PATH}
            class="ghost-mouth-top"
            fill="#000000"
          />
          <path
            d={GHOST_MOUTH_BOTTOM_PATH}
            class="ghost-mouth-bottom"
            fill="#000000"
          />
        </g>

        <g class="ghost-layer ghost-tick">
          <path d={GHOST_TICK_TOP_PATH} class="ghost-tick-top" fill="#6cb04e" />

          <path
            d={GHOST_TICK_BOTTOM_PATH}
            class="ghost-tick-bottom"
            fill="#6cb04e"
          />
        </g>
      </g>
...
<style>
  ...
  .ghost-svg.theme-peach #ghost-shape {
    animation-duration:
      var(--ghost-shimmer-duration, 5s), var(--ghost-peach-flow-duration, 9s);
  ...
  .ghost-svg.theme-mint #ghost-shape {
    animation-duration:
      var(--ghost-shimmer-duration, 6s), var(--ghost-mint-flow-duration, 10s);
    animation-timing-function:
      var(--ghost-shimmer-ease, ease-in-out),
  ...
  .ghost-svg.theme-bubblegum #ghost-shape {
    animation-duration:
      var(--ghost-shimmer-duration, 7s),
      var(--ghost-bubblegum-flow-duration, 12s);
    animation-timing-function:
      var(--ghost-shimmer-ease, ease-in-out),
