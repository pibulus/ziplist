...
export const LIST_COLOR_PRESETS = [
  ...
  {
    id: "list-peach",
    defaultName: "Peach List",
    color: "peach",
    primaryColor: "#ff9f68",
    accentColor: "#ffc19e",
    glowColor: "rgba(255, 159, 104, 0.28)",
  },
  {
    id: "list-sage",
    defaultName: "Sage List",
    color: "sage",
    primaryColor: "#52c785",
    accentColor: "#86efac",
    glowColor: "rgba(82, 199, 133, 0.28)",
  },
  {
    id: "list-indigo",
    defaultName: "Indigo List",
    color: "indigo",
    primaryColor: "#6366f1",
    accentColor: "#818cf8",
